...
- `GET /v1/admin/stats?lookbackMinutes=60` (admin telemetry: rate-limit saturation, admin action volume, internal call latency/error rollups with p50/p95 + bucket sample counts, failed-bet reason breakdowns, and event publish rates)
